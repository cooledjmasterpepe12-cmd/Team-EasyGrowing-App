...
export default function B2B() {
  ...
  return (
    <div style={{ background: '#121212', color: '#00ff00', minHeight: '100vh', padding: '20px', fontFamily: 'monospace' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '40px' }}>
        ...
        <div className="pixel-card-cyan" style={{ border: '3px solid #00e5ff', padding: '20px', background: '#1a1a1a' }}>
          ...
          <div style={{ marginTop: '15px', fontSize: '14px' }}>
            ...
            <div style={{ color: '#00ff00' }}>OpEx: ${opEx.toFixed(0)} | Yield: {yield_.toFixed(1)}kg</div>
          </div>
        </div>
      </div>

      {/* Purchase Orders Table */}
      <div className="pixel-card" style={{ border: '3px solid #00ff00', padding: '20px', background: '#1a1a1a', marginBottom: '40px', overflowX: 'auto' }}>
          ...
          <tbody>
            {[
              ...
              <tr key={i} style={{ borderBottom: '1px solid #00e5ff' }}>
                ...
                <td style={{ padding: '10px', color: '#00ff00' }}>{row.status}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      {/* Export Button */}
      <button className="pixel-btn-amber" style={{ padding: '12px 24px', fontSize: '14px', border: '3px solid #ffaa00', background: '#1a1a1a', color: '#ffaa00', cursor: 'pointer' }}>
        EXPORT REPORT
      </button>
    </div>
  );
